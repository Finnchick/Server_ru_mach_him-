                ...
                switch (request.getRequestType()) {
                    ...
                    case GRADE: {
                        ...
                        for (Produce produce :
                            ...
                            grade.setAppearance(grade.checkAppearance(produce.getfStandart().getAppearance(), produce.getAppearance()));
                            grade.setSize(grade.checkSize(produce.getfStandart().getSize(), produce.getSize()));
                            grade.setStrength(grade.checkStrength(produce.getfStandart().getStrength(), produce.getStrength()));
                            grade.setThickness(grade.checkThickness(produce.getfStandart().getThickness(), produce.getThickness()));
                            grade.setWeight(grade.checkWeight(produce.getfStandart().getWeight(), produce.getWeight()));
                            grade.getResult();
                            grades.add(grade);
                        }
                    ...
                    case GET_PRODUCT: {
                        Produce produce = gson.fromJson(request.getRequestMessage(), Produce.class);
                        EntityService<Produce> entityService = new EntityService<>(Produce.class);
                        produce = entityService.GetEntity(produce.getId());
                    ...
                    case GET_USER: {
                        User user = gson.fromJson(request.getRequestMessage(), User.class);
                        EntityService<User> entityService = new EntityService<>(User.class);
                        user = entityService.GetEntity(user.getId());
                        response = new Response(ResponseStatus.OK, "Готово!", gson.toJson(user));
                        break;
                    }
                    case DELETE_USER: {
                    ...
                    case GET_WORKER: {
                        Worker worker = gson.fromJson(request.getRequestMessage(), Worker.class);
                        EntityService<Worker> entityService = new EntityService<>(Worker.class);
                        worker = entityService.GetEntity(worker.getId());
                    ...
                    case GET_BATCH: {
                        Batch batch = gson.fromJson(request.getRequestMessage(), Batch.class);
                        EntityService<Batch> entityService = new EntityService<>(Batch.class);
                        batch = entityService.GetEntity(batch.getId());
                    ...
                    case GET_STANDART: {
                        Standart standart = gson.fromJson(request.getRequestMessage(), Standart.class);
                        EntityService<Standart> entityService = new EntityService<>(Standart.class);
                        standart = entityService.GetEntity(standart.getId());
